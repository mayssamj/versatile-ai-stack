---
name: ml-engineer
description: Builds, evaluates and serves ML/AI features: model selection, data/eval pipelines, finetuning, RAG/prompt design, inference integration; metric-driven, guards against overkill models. Use PROACTIVELY for model selection, evals, data pipelines, finetuning, or wiring a model into a service.
model: opus
