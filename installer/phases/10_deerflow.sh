...
note "Stop:   bash $AI_STACK/mayssam-ai-stack.sh stop deerflow      (or: stack stop deerflow)"
note "Start:  bash $AI_STACK/mayssam-ai-stack.sh start deerflow     (or: stack start deerflow)"
