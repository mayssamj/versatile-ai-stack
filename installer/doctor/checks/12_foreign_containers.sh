...
CHECK_TITLE[foreign_containers]="No foreign ai-stack containers (run 'mayssam-ai-stack.sh adopt <svc>')"
...
foreign_containers_fix() {
  warn "Run 'mayssam-ai-stack.sh adopt <svc>' per foreign container — adoption is interactive"
