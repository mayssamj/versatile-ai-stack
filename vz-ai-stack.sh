...
Phases (in install order) — pass the id OR the name (run `vz-ai-stack.sh phases` for the table):
  ...
  opt-in extras (not in `install all`): 21 portless · 22 cmux · 23 skillspector · 24 openagents · 25 lmstudio · 27 sourcegraph · 28 aionui · 29 openwork · 30 understand · 32 metagpt · 33 agentscope · 34 oasis
...
install_plan() {
  ...
  echo
  [[ "$target" == "all" ]] && note "(Opt-in extras 21–25 · 27 · 28 · 29 · 30 · 32 · 33 · 34 — portless · cmux · skillspector · openagents · lmstudio · sourcegraph · aionui · openwork · understand · metagpt · agentscope · oasis — are NOT in 'install all'; install them by name.)"
