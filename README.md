...
- **One installer, self-healing and reversible** — brings up all 44 services, resumes if interrupted, never destroys a running container without confirmation, and proves itself with 53/53 doctor checks.
...
│   ├── doctor/checks/      # one file per failure mode (53 checks)
...
- **29 core install phases (+9 opt-in extras: portless · cmux · skillspector · openagents · lmstudio · sourcegraph · aionui · openwork · understand) · 44 services · 53 doctor checks.**
