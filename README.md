...
- **One installer, self-healing and reversible** — brings up all 40 services, resumes if interrupted, never destroys a running container without confirmation, and proves itself with 47/47 doctor checks.
...
# 5. Verify everything is healthy. Expect 47/47.
...
- **Something's broken** — read [DOCTOR.md](doc/DOCTOR.md) for what each of the 47
...
│   ├── doctor/checks/      # one file per failure mode (47 checks)
...
- **28 core install phases (+6 opt-in extras: portless · cmux · skillspector · openagents · lmstudio · mempalace) · 40 services · 47 doctor checks.**
