...
- **One installer, self-healing and reversible** — brings up all 49 services, resumes if interrupted, never destroys a running container without confirmation, and proves itself with 62/62 doctor checks.
...
> **AI-Stack Explorer** — *“All 49 installed services · 59 cards across 7 tiers · self-contained — works offline from file://”*
...
# 5. Verify everything is healthy. Expect 62/62.
...
- **[COMPONENTS.md](doc/COMPONENTS.md)** — brief catalog of everything in the stack:
  all 49 services + CLI tools, grouped by layer (inference, memory, agents, UIs,
...
- **Something's broken** — read [DOCTOR.md](doc/DOCTOR.md) for what each of the 62
...
├── services.yml            # single source of truth (49 services, 4 profiles)
...
│   ├── doctor/checks/      # one file per failure mode (62 checks)
...
- **29 core install phases (+14 opt-in extras: portless · cmux · skillspector · openagents · lmstudio · sourcegraph · aionui · openwork · understand · metagpt · agentscope · oasis · chatdev · aitown) · 49 services · 62 doctor checks.**
