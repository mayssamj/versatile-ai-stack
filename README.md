...
- **One installer, self-healing and reversible** — brings up all 44 services, resumes if interrupted, never destroys a running container without confirmation, and proves itself with 55/55 doctor checks.
...
# 5. Verify everything is healthy. Expect 55/55.
...
│   ├── doctor/checks/      # one file per failure mode (55 checks)
