...
- **One installer, self-healing and reversible** — brings up all 40 services, resumes if interrupted, never destroys a running container without confirmation, and proves itself with 44/44 doctor checks.
...
> **AI-Stack Explorer** — *“All 40 installed services · 47 cards across 7 tiers · self-contained — works offline from file://”*
...
# 3. Verify everything is healthy. Expect 44/44.
...
│   ├── doctor/checks/      # one file per failure mode (44 checks)
