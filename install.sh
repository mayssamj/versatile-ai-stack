...
Phases (in install order):
  00 00s 00n 00v 02 03 01 01h 04 04f 04g 05 06 07 08 09 10 11 12 13 14 15 16 17 18
...
cmd_install() {
  ...
  if [[ "$target" == "all" ]]; then
    ...
    local phases=(00 00s 00n 00v 02 03 01 01h 04 04f 04g 05 06 07 08 09 10 11 12 13 14 15 16 17 18)
    for p in "${phases[@]}"; do
      run_phase "$p" || {
