...
[[ -d "$CLAW_DIR" && -f "$CLAW_DIR/server/index.js" ]] || { err "claw3d not installed at $CLAW_DIR — run 'mayssam-ai-stack.sh install 19'"; exit 1; }
[[ -d "$CLAW_DIR/node_modules" ]] || { err "claw3d node_modules missing — run 'mayssam-ai-stack.sh install 19' (npm install)"; exit 1; }
