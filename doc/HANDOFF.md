...
`start claw3d` (or `start claw3d-bridge`, hyphen). doctor count **62**; services **49**.
...
- `doctor [<filter>]` — 62 checks, per-check auto-fix
...
2. `stack doctor` — 62 checks, each with auto-fix offer.
