...
- **29 core install phases** (+12 opt-in extras: `portless`, `cmux`, `skillspector`, `openagents`, `lmstudio`, `sourcegraph`, `aionui`, `openwork`, `understand`, `metagpt`, `agentscope`, `oasis`), **47 services** (`services.yml`), **60 doctor checks**.
