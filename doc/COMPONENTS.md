...
- **29 core install phases** (+14 opt-in extras: `portless`, `cmux`, `skillspector`, `openagents`, `lmstudio`, `sourcegraph`, `aionui`, `openwork`, `understand`, `metagpt`, `agentscope`, `oasis`, `chatdev`, `aitown`), **49 services** (`services.yml`), **65 doctor checks**.
