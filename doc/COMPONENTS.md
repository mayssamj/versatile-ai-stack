...
- **29 core install phases** (+9 opt-in extras: `portless`, `cmux`, `skillspector`, `openagents`, `lmstudio`, `sourcegraph`, `aionui`, `openwork`, `understand`), **44 services** (`services.yml`), **54 doctor checks**.
