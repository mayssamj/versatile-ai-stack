...
this specific combination of 34 services. Not a programming novice — no
...
```bash
# 1. Confirm the stack is healthy. Target: 33/33 ✓
...
Doctor stays at 33/33 across every profile flip as long as the underlying services are healthy. If doctor drops, fix it before you do anything else.
