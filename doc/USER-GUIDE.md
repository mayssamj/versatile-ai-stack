...
this specific combination of 33 services. Not a programming novice — no
...
```bash
# 1. Confirm the stack is healthy. Target: 31/31 ✓
...
Doctor stays at 31/31 across every profile flip as long as the underlying services are healthy. If doctor drops, fix it before you do anything else.
