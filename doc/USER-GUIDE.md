...
this specific combination of 38 services. Not a programming novice — no
...
```bash
# 1. Confirm the stack is healthy. Target: 37/37 ✓
...
Doctor stays at 37/37 across every profile flip as long as the underlying services are healthy. If doctor drops, fix it before you do anything else.
