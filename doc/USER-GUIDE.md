...
```bash
# 1. Confirm the stack is healthy. Target: 47/47 ✓
...
Doctor stays at 47/47 across every profile flip as long as the underlying services are healthy. If doctor drops, fix it before you do anything else.
