...
```bash
# 1. Confirm the stack is healthy. Target: 57/57 ✓
...
Doctor stays at 57/57 across every profile flip as long as the underlying services are healthy. If doctor drops, fix it before you do anything else.
