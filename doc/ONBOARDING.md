...
bash vz-ai-stack.sh doctor            # 72 checks — target all green
```
...
stack doctor        # 70 health checks + per-check auto-fix offers (your first move when something's off)
...
## 5. Opt-in extras (Phases 21–25, 27–38) — add only what you want
